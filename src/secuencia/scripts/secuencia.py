...
robot = MoveGroupPythonInterface("cr7ia")
joint_list, cartesian_position, cartesian_orientation=robot.get_position()
print("Angulos: ", joint_list)
print("Pos (X,Y,Z): ", cartesian_position)
print("Orientacion: ", cartesian_orientation)

robot.go_to_home()

robot.scale_ROT = 1.0
robot.joints_move("j3","reverse")                                   
robot.cartesian_pos("x","forward")
robot.cartesian_pos("z","reverse")     
robot.joints_move("j0","reverse")
robot.scale_LIN = 0.25 
